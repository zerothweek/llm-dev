...
st.set_page_config(page_title="EXAONE-3.5-2.4B-SFT")
st.title("EXAONE-3.5-2.4B-SFT")
st.markdown(
    """
    🎧
    """
...
#########################################
model_name = '../models/EXAONE-3.5-2.4B-Instruct-SFT/checkpoint-300'
...
st.session_state.system_message = "너는 병역이행법 상담을 도와주는 챗봇이야."
